...
<div style="padding: 0px 300px;">
  <div class="container" >
    ...
    <table class="tourcart_table" style="font-family: Montserrat, Helvetica Neue, Arial, sans-serif; font-size: 0.8em;">
      <form:form method="POST" action="orderpage/updateOrder.do">
        <col class="col_150">
        <col class="col_250">
        <tr>
          <td><h5>Номер заявки</h5></td>
          <td><h5><c:out value="${order.id}"></c:out></h5></td>
        </tr>
        <tr>
          <td><h5>Дата заявки</h5></td>
          <td><h5><fmt:formatDate pattern="dd.MM.yyyy" value="${order.orderDate}"/></h5></td>
        </tr>
        <tr>
          <td><h5>Клиент</h5></td>
          <td><h5><c:out value="${order.client.getFIO()}"></c:out></h5></td>
        </tr>
        <tr>
        <tr>
          <td><h5>Комментарий к заявке</h5></td>
          <td style="text-align: center">
                        <textarea readonly="${order.statusOrder.getId()==1 ? "" : "readonly"}"
                                  rows="10" cols="60"
                                  name="comment_order">${order.comment}</textarea>
          </td>
        <tr>
          <td><h5>Тур</h5></td>
          <td><h5><c:out value="${order.tourDate.tour.name}"></c:out></h5></td>
        </tr>
        <tr>
          <td><h5>Цена</h5></td>
          <td>
            ...
            <div class="quantity_wr_2" style="text-align: center">
              <div class="quantity_inner">
                <button type="button" class="bt_minus"
                        readonly="${order.statusOrder.getId()==1 ? "" : "readonly"}">
        ...
        <tr>
          <td><h5>Статус заявки</h5></td>
          <td><h5><c:out value="${order.statusOrder.name}"></c:out></h5></td>
        </tr>
        <tr>
          <td><h5>Примечание</h5></td>
          <td style="text-align: center">
            <textarea readonly rows="4" cols="60" name="note_order" maxlength="100">${order.note}</textarea>
          </td>
        </tr>
        <tr>
          <td></td>
          <td style="text-align: center">
            ...
            <button class="boxed-btn35"
                    name="saveOrder" type="submit">
              <spring:message code="saveorder"/>
            </button>
          </td>
        </tr>
